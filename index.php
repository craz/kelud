...
$APPLICATION->SetPageProperty("keywords", "окаменелое дерево,элитный столы из окаменелого дерева, купить элитную мебель из массива дерева, интернет магазин элитной мебели,");
