...
$APPLICATION->SetPageProperty("TITLE", "Сертификаты Kelud");
$APPLICATION->SetPageProperty("description", "Сертификаты и экспертное заключение магазина элитной мебели KELUD");
