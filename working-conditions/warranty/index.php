...
$APPLICATION->SetPageProperty("TITLE", "Гарантия и возврат товара");
$APPLICATION->SetPageProperty("description", "Гарантийные обязательства и способы возврата товара в магазине элитной мебели KELUD.");
