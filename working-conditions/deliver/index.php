...
$APPLICATION->SetPageProperty("TITLE", "Доставка заказанного товара");
$APPLICATION->SetPageProperty("description", "Описание процесса и способов доставки товара интернет-магазина элитной мебели KELUD.");
