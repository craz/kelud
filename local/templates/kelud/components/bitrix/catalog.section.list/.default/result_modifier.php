...
{
    $section["PICTURE"] = CFile::GetFileArray($section["PICTURE"]["ID"]);
    $section["PICTURE"] = CFile::ResizeImageGet($section["PICTURE"], array('width' => 300, 'height' => 300), BX_RESIZE_IMAGE_PROPORTIONAL, true);
    $section["PICTURE"]["SRC"] = $section["PICTURE"]["src"];
}
